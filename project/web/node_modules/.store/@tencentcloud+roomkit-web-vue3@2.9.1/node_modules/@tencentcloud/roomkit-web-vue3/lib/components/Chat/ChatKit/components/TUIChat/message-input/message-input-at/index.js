...
const MessageInputAtSuggestion = () => {
  return {
    ...
    items: (props) => {
      ...
      universalApi.TUIGlobal.setShowMemberList(showMemberList);
    ...
    render: () => {
      return {
        onStart: (props) => {
          ...
          universalApi.TUIGlobal.toggleAtList(true);
          if (!(props == null ? void 0 : props.clientRect)) {
            return;
          }
          const rect = props == null ? void 0 : props.clientRect();
          if ((rect == null ? void 0 : rect.left) && (rect == null ? void 0 : rect.top) && !env.isH5) {
            universalApi.TUIGlobal.handleAtListPosition({
        ...
        onKeyDown(props) {
          ...
          if (props.event.key === "Escape") {
            universalApi.TUIGlobal.toggleAtList(false);
            showMemberList = allMemberList;
            return true;
          }
...
const upHandler = () => {
  ...
  universalApi.TUIGlobal.setCurrentSelectIndex(selectedIndex);
};
const downHandler = () => {
  if (!(showMemberList == null ? void 0 : showMemberList.length)) return;
...
universalApi.TUIGlobal.selectItem = selectItem;
exports.default = MessageInputAtSuggestion;
