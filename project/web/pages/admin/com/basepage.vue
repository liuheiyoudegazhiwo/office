<template>
    <div class="user-main" v-loading="pendingflag">
        ...
        <!-- 信息弹框  -->
        <el-dialog :title="roleinfotitle"  v-model="dialogroleVisible" width="600px" append-to-body
            class="diaitemrole">
            <el-form ref="form" :model="form" :rules="rules" label-width="80px">
                <el-row>
                    <el-col :span="24">
                        <el-form-item label="标题" prop="title">
                            <el-input v-model="form.result2" placeholder="请输入标题" />
                        </el-form-item>
                    </el-col>
                    <el-col :span="24">
                        <el-form-item label="类型" prop="title">
                            <el-select v-model="form.result1" placeholder="请选择">
                    ...
                    <el-col :span="24">
                        <el-form-item label="图片" prop="trans_pic">
                    ...
                    <el-col :span="24">
                        <el-form-item label="内容" prop="detail">
                            <el-input type="textarea" :rows="5" v-model="form.result3" placeholder="请输入内容">
                            </el-input>
                        </el-form-item>
                    </el-col>
                </el-row>
...
<script>
import { querylistdata, insertlistdata, updatebasemsg, updatebasemsgstatus, listdataremove } from '@/api/sysapi'
    ...
    data() {
        return {
            ...
            griddata: [
                ...
                { prop: 'result1', label: 'result1', width: '200' },
            ],
            tableData: [],
            fileListwl: [],
            multipleSelection: [],
        ...
        userinfosubmit() {
            ...
            if (this.roleinfotitle == "新增") {
                let objadd = {
                    ...
                    result1: this.form.result1,
                    result2: this.form.result2,
                    result3: this.form.result3,
                    result4: this.form.result4,
                    result5: this.form.result5,
                    result6: this.form.result6,
                    result7: this.form.result7,
                    result8: this.form.result8,
                    result9: this.form.result9,
                    result10: this.form.result10,
                ...
                updatebasemsg(objedit).then(res => {
                    this.query()
                    this.$message.success('操作成功')
                    this.dialogitemVisible = false
                }).catch(error => {
