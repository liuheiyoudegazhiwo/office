...
const EN = {
  ...
  "Enable AI real-time meeting recording": "Enable AI real-time meeting recording",
  ...
  "Screen sharing is currently active, cannot start the whiteboard.": "Screen sharing is currently active, cannot start the whiteboard.",
  ...
  "An invitation to open the microphone has been sent to sb.": ({
    named
  }) => `An invitation to open the microphone has been sent to ${named("name")}`,
  ...
  "X people have joined": ({ named }) => `${named("number")} people have joined`,
  "Waiting for members to join the meeting": "Waiting for members to join the meeting",
  "X people are in the meeting": ({ named }) => `${named("number")} people are in the meeting`,
  ...
  "The system prohibits the current browser from accessing the screen content, please enable the screen sharing privilege.": "The system prohibits the current browser from accessing the screen content, please enable the screen sharing privilege.",
  "User canceled screen sharing": "User canceled screen sharing",
  "An unknown error occurred while screen sharing, please try again.": "An unknown error occurred while screen sharing, please try again.",
  "I got it": "I got it",
  Attention: "Attention",
  'Audio playback failed. Click the "Confirm" to resume playback': 'Audio playback failed. Click the "Confirm" to resume playback.',
  // Schedule Room
  "x people selected": ({ named }) => `${named("number")} people selected`,
  ...
  "media device failed to open, please check the media device and try again": ({
    named
  }) => `${named("deviceType")} failed to open, please check the ${named("deviceType")} and try again`,
  ...
  addMember: "addMember",
  shareRoom: "shareRoom",
  "Invitation sent, waiting for members to join.": "Invitation sent, waiting for members to join.",
  ...
  "Your room password format is incorrect, please check it": "Your room password format is incorrect, please check it",
  Security: "Security",
  ...
  "You are sharing the whiteboard, please stop sharing first": "You are sharing the whiteboard, please stop sharing first",
  "Line Size": "Line Size",
  ...
  Reset: "Reset",
  Degree: "Degree",
  "Sure you want to reset the beauty effect?": "Sure you want to reset the beauty effect?",
  "All beauty parameters will revert to default after reset": "All beauty parameters will revert to default after reset",
