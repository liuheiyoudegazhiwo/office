...
const ZH = {
  ...
  "Screen sharing is currently active, cannot start the whiteboard.": "当前正在屏幕共享，无法开启白板",
  ...
  Initiating: "正在发起",
  "X people have joined": ({ named }) => `${named("number")} 人已入会`,
  "Waiting for members to join the meeting": "等待成员入会",
  "X people are in the meeting": ({ named }) => `${named("number")} 人在会议中`,
  "Already joined": "已入会",
  ...
  "The system prohibits the current browser from accessing the screen content, please enable the screen sharing privilege.": "系统禁止当前浏览器获取屏幕内容, 请开启屏幕分享权限。",
  "User canceled screen sharing": "用户取消屏幕分享",
  "An unknown error occurred while screen sharing, please try again.": "屏幕分享发生了未知错误，请重试",
  "I got it": "我知道了",
  Attention: "注意",
  'Audio playback failed. Click the "Confirm" to resume playback': "音频播放失败。单击 “确认 ”恢复播放。",
  // Schedule Room
  "x people selected": ({ named }) => `已选择${named("number")}人`,
  Modify: "修改",
  "view details": "查看详情",
  "modify room": "修改房间",
  "cancel room": "取消房间",
  ...
  addMember: "添加成员",
  shareRoom: "分享房间",
  "Invitation sent, waiting for members to join.": "邀请信息已发出，等待成员加入",
  ...
  "Your room password format is incorrect, please check it": "房间密码格式不正确，请检查",
  Security: "安全设置",
  "Room Password": "进房密码",
  ...
  "End annotating": "结束批注",
  "You are sharing the whiteboard, please stop sharing first": "您正在共享白板，请先停止共享",
  "Line Size": "线条粗细",
  "Line Color": "线条颜色",
  "Arrow Size": "箭头大小",
  "Arrow Color": "箭头颜色",
  ...
  "All beauty parameters will revert to default after reset": "重置后所有美颜参数将恢复至默认",
  "Theme Colours": "主题色",
  "Custom Themes": "自定义主题"
};
exports.default = ZH;
