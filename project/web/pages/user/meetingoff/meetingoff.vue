<template>
						...
						<el-table border :header-cell-style="{ 'text-align': 'center', 'background-color': '#f1f1f1' }"
							...
							<el-table-column label="操作" width="160">
								<template #default="scope">
									...
									<el-button  v-if="scope.row.status == '已接单' &&  scope.row.userid2 == userinfo.id" type="warning" plain size="mini"
	...
	<!-- 				<el-col :span="24">
						<el-form-item label="优先级" prop="field2">
					...
					<el-col :span="24">
						<el-form-item label="时间段" prop="detail">
							<el-date-picker value-format="YYYY-MM-DD" v-model="form.field3" type="daterange"
...
<!-- 					<el-col :span="24">
						<el-form-item label="指派人员" prop="detail">
							<el-select v-model="form.userid2" placeholder="请选择">
					...
					<el-col :span="24">
						<el-form-item label="备注" prop="detail">
							<el-input type="textarea" :rows="5" v-model="form.field4" placeholder="请输入内容">
							</el-input>
						</el-form-item>
					</el-col>
				</el-row>
		...
		methods: {
			...
			userinfosubmit() {
				...
				let objadd = {
					...
					field3: JSON.stringify(this.form.field3),
				...
				if (this.form.userid2) {
					objadd.userid2 = this.form.userid2
					objadd.datetime2 = this.getnowdate() + " " + this.getnowtime()
					objadd.status = '已接单'
				}
				//获取当前选中的菜单，将id存入数组
			...
			updatafun(index, row, bj) {
				...
				if(bj == '已完成'){
					objext.userid3 = this.userinfo.id
					objext.datetime3 = this.getnowdate() + " " + this.getnowtime()
					objext.status = '已完成'
					str = '完成'
				}
				this.$confirm(`您将${str}该会议?`, '提示', {
