  ...
  return openBlock(), createElementBlock("svg", _hoisted_1, _cache[0] || (_cache[0] = [
    ...
    createElementVNode("defs", null, [
      createElementVNode("linearGradient", {
        ...
        createElementVNode("stop", { "stop-color": "#00CED9" }),
...
const LogoTitleOfMobileInChinese = /* @__PURE__ */ _export_sfc(_sfc_main, [["render", _sfc_render]]);
export {
  LogoTitleOfMobileInChinese as default
};
