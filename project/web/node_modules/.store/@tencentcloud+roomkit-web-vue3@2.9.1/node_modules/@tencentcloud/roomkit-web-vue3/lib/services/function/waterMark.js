...
class WaterMark {
  ...
  bindEvent() {
    this.service.on(types.EventType.ROOM_START, this.handleRoomStart);
    this.service.on(types.EventType.ROOM_JOIN, this.handleRoomJoin);
  }
  dispose() {
    this.service.off(types.EventType.ROOM_START, this.handleRoomStart);
    this.service.off(types.EventType.ROOM_JOIN, this.handleRoomJoin);
  }
