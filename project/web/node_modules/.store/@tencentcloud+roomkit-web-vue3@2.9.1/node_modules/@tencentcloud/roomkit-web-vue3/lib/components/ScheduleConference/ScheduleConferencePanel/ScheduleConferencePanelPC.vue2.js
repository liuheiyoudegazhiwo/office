...
const HideContentIcon = require("../../common/icons/HideContentIcon.vue.js");
const ShowContentIcon = require("../../common/icons/ShowContentIcon.vue.js");
                ...
                !isEditMode.value ? (Vue.openBlock(), Vue.createElementBlock("div", _hoisted_23, [
                  ...
                  Vue.createElementVNode("div", _hoisted_25, [
                    ...
                    passwordChecked.value ? (Vue.openBlock(), Vue.createBlock(Vue.unref(index$1.default), {
                      ...
                      suffixIcon: Vue.withCtx(() => [
                        isShowPassword.value ? (Vue.openBlock(), Vue.createBlock(SvgIcon.default, {
                          key: 0,
                          class: "icon",
                          onClick: toggleShowPassword,
                          icon: ShowContentIcon.default
                        })) : (Vue.openBlock(), Vue.createBlock(SvgIcon.default, {
                          key: 1,
                          class: "icon",
                          onClick: toggleShowPassword,
                          icon: HideContentIcon.default
                        }))
                      ]),
                      _: 1
