...
const BASIC_EMOJI_NAME_TO_KEY_MAPPING = {
  ...Object.fromEntries(
    (_a = Object.entries(zh_cn.default)) == null ? void 0 : _a.map(([key, val]) => [val, key])
  ),
  ...Object.fromEntries(
    (_b = Object.entries(en.default)) == null ? void 0 : _b.map(([key, val]) => [val, key])
  )
};
